...
// ("Durable Object storage operation exceeded timeout"). Retentamos em 5xx / timeout.
...
async function request(path, body, tentativas = 3) {
  if (!COOKIE) {
  ...
  for (let i = 1; i <= tentativas; i++) {
    try {
      ...
      ultimoErro = e;
      // Não retenta erro de sessão (401/302) — só falha transitória de infra.
