      ...
      >
        <div>
          ...
          <div className="mt-1 text-sm text-white/80">
            {total === 1 ? "pessoa será notificada" : "pessoas serão notificadas"}
          </div>
        </div>
          ...
          <p className="mt-0.5 text-sm text-muted-foreground">
            {carregando
              ...
              : total === 0
                ...
                : `${total} pessoa(s) com projeto(s) ainda não atualizado(s).`}
          </p>
                ...
                return (
                  <li key={r.email} className="px-4 py-3">
                    <button
                      ...
                      className="flex w-full items-center justify-between gap-3 text-left focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring rounded"
      ...
      <Dialog open={confirmOpen} onOpenChange={setConfirmOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Você vai enviar este e-mail para <strong>{total} pessoa(s)</strong> (
              {data?.totalProjetos} projeto(s) pendentes). A ação é registrada e o envio roda em
              segundo plano. Deseja continuar?
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
