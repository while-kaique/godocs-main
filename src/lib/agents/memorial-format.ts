...
export const MEMORIAL_ESQUELETO: Record<ModoMemorial, SecaoEsqueleto[]> = {
  saving: [
    ...
    { secao: 'Contratos/Serviços Evitados', nivel: 'opcional', gatilho: 'há um custo externo evitado DISTINTO das horas', conteudo: 'QUAL gasto a empresa deixou de pagar — o rótulo não importa (contrato, licença, serviço de terceiro, taxa, multa, juros, retrabalho pago) —, o efeito qualitativo (sem R$) e o rateio. "N/A" quando não há.' },
