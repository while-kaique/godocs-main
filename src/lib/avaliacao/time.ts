...
{ "sinais": ["<condição-limite detectada>", "..."], "motivo": "<uma frase concreta com a evidência, ou null>", "refuta": <bool>, "pergunta_ao_autor": "<quando refuta: UMA pergunta (até 220 caracteres) que o autor consegue responder e que resolve a sua refutação; sem R$ por hora; null se a refutação não se resolve com o autor>" }`;
  const user = [
    'DOSSIÊ DO PROJETO:',
    args.dossieTexto,
    '',
