...
⚠️ **LEIA a linha "O QUE É EXIGÍVEL AQUI" do dossiê antes de cobrar qualquer campo.** Se o autor declarou **ganho imensurável**, o formulário NÃO pede horas nem valor: a ausência delas é a resposta certa e cobrá-las é cobrar o impossível. Se declarou **custo evitado**, as horas liberadas estão em "Horas humanas liberadas" — confira ali antes de dizer que faltam. _(Medido em prod, 10/09/2026: 13 de 24 pareceres pediam "as horas mensais e o número de pessoas", e 8 deles eram de projeto com ganho imensurável declarado — ou seja, o defeito era meu, não do autor.)_
⚠️ **"Impacto bruto" e "impacto líquido mensal" DIFEREM POR CONSTRUÇÃO** (no líquido as horas entram ponderadas) e os dois estão corretos. NÃO trate a diferença entre eles como divergência a conciliar, e use o LÍQUIDO MENSAL como o número do projeto.`,
...
⚠️ **"Impacto bruto" × "impacto líquido mensal" NÃO é divergência:** eles diferem por construção (no líquido as horas entram ponderadas), os dois estão corretos e o número do projeto é o LÍQUIDO MENSAL. Pedir para "conciliar os dois valores" é pedir para o autor consertar algo que não está quebrado. _(Medido em prod, 10/09/2026: 2 dos 4 pareceres de "divergência de valor" eram exatamente o fator 2 do peso das horas.)_
⚠️ **Leia "O QUE É EXIGÍVEL AQUI" antes de cobrar campo:** em ganho imensurável não se pede horas nem R$; em custo evitado não se pede extrato de despesa que nunca nasceu.
