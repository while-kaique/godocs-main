    ...
    <div>
      ...
      {resp === "sim" && (
        <div style={{ animation: "go-step-in 0.3s cubic-bezier(0.4, 0, 0.2, 1) both" }}>
          ...
          {/* Bloqueio — aparece no instante do "sim", sem esperar o clique em enviar. Mesmo
              painel âmbar dos outros bloqueios de preenchimento (`AvisoBloqueio`): o problema
              é a classificação que a pessoa escolheu, não uma falha do sistema. */}
          {motivoBloqueio && <AvisoBloqueio bloqueio={bloqueioEspecialInvalido(motivoBloqueio)} />}
        </div>
      )}
