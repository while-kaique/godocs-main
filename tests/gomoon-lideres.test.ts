...
describe('montarPayloadLideresPendentes — formato do contrato (§3)', () => {
  ...
  it('⚠️ a mensagem do líder vai PRONTA no payload e casa com a lista de liderados (§13)', () => {
    ...
    // ⚠️ O link NÃO vai na prosa (06/08/2026): quem leva o líder à fila é o botão
    // "Abrir a fila", que o Gomoon monta do campo `url` — ter os dois punha o mesmo
    // endereço 2× na DM. Por isso o campo `url` é obrigatório aqui: sem ele o botão
    // fica sem destino e a mensagem perde o único caminho até a tela.
