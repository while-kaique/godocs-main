...
// ⚠️ Tipo ESTRUTURAL, não a linha inteira: o teste lê `aprovador_email` além do estágio e
// do veredito, e prender a assinatura completa de `AprovacaoRow` aqui faria este teste
// quebrar a cada coluna nova da tabela.
function pendentesDe(
  linhas: { estagio: number; veredito: string; aprovador_email?: string | null }[],
  estagio: number,
) {
