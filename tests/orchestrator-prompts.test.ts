...
describe('Prompt fase doc', () => {
  ...
  it('padroniza a verificação de IA: infere dos arquivos, SEMPRE pergunta com caixas de seleção, detecta contradição', async () => {
    ...
    // Passo 2.5: se "Sim", SEMPRE pede o detalhamento de como a IA é usada (aceita resposta simples)
    expect(system).toContain('PASSO 2.5 — SE "SIM", SEMPRE PEÇA O DETALHAMENTO DE COMO A IA É USADA');
