...
| [criterios-projeto-classificacao](criterios-projeto-classificacao.md) ◀ | ✅ **executado** (2026-07-30 — T1–T7 + R1/R2/R3 + **T8: gate determinístico do `[1.3]`/`[1.4]`**, `9ce9b09`) — validado em staging em 29/07 (pontos 3/4/5 ok, 1/2 falharam → gate feito); **falta** deployar o gate na staging + re-rodar o E2E + validar o analisador pela rota nova `POST /api/admin/reanalisar-pendentes` |
